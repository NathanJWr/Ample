...
AmpObject *
interpreter_evaluate_statement_to_bool (ASTHandle statement_handle,
                                        DICT (ObjVars) **variable_scope_stack);
/* evaluates each side of an binary_comparison statement 
 * and returns true if the statement is true */
AmpObject *
