...
AmpObject *interpreter_evaluate_if(ASTHandle statement, DICT (ObjVars) **variable_scope_stack, bool32 *return_from_scope);
 ...
 * and evaulates them */
AmpObject *interpreter_evaluate_scope (ASTHandle scope_handle, DICT (ObjVars) **variable_scope_stack, bool32 local_scope_already_created, bool32 *should_return);
...
AmpObject *interpreter_evaluate_function_call (ASTHandle func_call, DICT (ObjVars) **variable_scope_stack, bool32 *return_from_scope);
